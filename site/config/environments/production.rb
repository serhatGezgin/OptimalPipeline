Opsite::Application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    :port                 => 587,
    :domain               => 'optimalpipeline.com',
    :user_name            => 'websitecontact@optimalpipeline.com',
    :password             => 'g6Jn414dVUkmVm2',
    :authentication       => 'plain',
    :enable_starttls_auto => true  }
  config.action_mailer.default_url_options = { :host => 'freezing-sunset-8481.herokuapp.com' }
